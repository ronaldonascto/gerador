...
SCPT_DIR="/etc/SCRIPT"
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3JvbmFsZG9uYXNjdG8vZ2VyYWRvci9tYXN0ZXIvZ2VyYWRvcg=="
SUB_DOM='base64 -d'
rm $(pwd)/$0
ofus () {
unset txtofus
...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/ronaldonascto/gerador/master/Install/trans &> /dev/null
